...
var Liquid = function (_React$Component) {
  ...
  function Liquid(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, (Liquid.__proto__ || Object.getPrototypeOf(Liquid)).call(this, props));
  ...
  _createClass(Liquid, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('http://react.local/colors.php').then(function (response) {
      ...
      if (data !== null) {
        if (data.backgroundheader !== null) {
          return _react2.default.createElement(
            "div",
            { className: "container h1", style: data.backgroundheader },
            "Test Hello"
          );
        }
      }
...
_reactDom2.default.render(_react2.default.createElement(Liquid, null), app);

},{"react":21,"react-dom":18,"redux":27}],2:[function(require,module,exports){
...
},{"_process":13,"object-assign":12,"prop-types/checkPropTypes":14,"react":21,"scheduler":33,"scheduler/tracing":34}],17:[function(require,module,exports){
/** @license React v16.6.1
...
},{"object-assign":12,"react":21,"scheduler":33}],18:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./createStore":26,"./utils/warning":28,"_process":13,"lodash/isPlainObject":11}],25:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":11,"symbol-observable":35}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":22,"./bindActionCreators":23,"./combineReducers":24,"./compose":25,"./createStore":26,"./utils/warning":28,"_process":13}],28:[function(require,module,exports){
'use strict';
